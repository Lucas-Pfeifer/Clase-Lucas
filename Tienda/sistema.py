...
while comprando:
    ...
    while Cantidad_No_Valida:
        comprar_producto = str(input("Ingresa el ID del producto que desea comprar: "))
        cantidad_producto = int(input("Ingresa la cantidad del producto ya seleccionado: "))
        ...
        if Mi_Tienda.validar(comprar_producto) and Mi_Tienda.productos[comprar_producto].validar(cantidad_producto): # + extra (si quiero considerar los productos ya en el carro )
            carro[comprar_producto] = cantidad_producto
